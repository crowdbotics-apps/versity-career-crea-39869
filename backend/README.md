...
## Project Structure
    ...
    ├── versity_career_crea_39869  # Django project configurations
...
1. Clone this repo and `cd versity_career_crea_39869`
...
2. Clone this repo and `cd versity_career_crea_39869`
